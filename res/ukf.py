...
class UnscentedKalmanFilter:
    def __init__(self, f, x0, p0, h=None, process_noise=None, observation_noise=None, uk0=None, recycle_sigma_points=True,
                 kappa=1.0, input_at_output=False):
    ...
    def aPosterioriEstimation(self, uk0, yk1, internal=False, process_noise=None, observation_noise=None):
        ...
        if self.recycleSigmaPoints:
            ...
            self.y_prior = weightedSum(self.priorX, self.weights)
